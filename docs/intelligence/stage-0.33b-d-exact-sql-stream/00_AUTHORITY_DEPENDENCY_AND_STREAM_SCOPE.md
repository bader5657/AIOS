...
Every result is accepted only after its exact preceding frame and statement ID. Notation is (projected CSV field count, expected row count). The manifest is: I01(4,1), I02(7,1), M01/M02(1,0), S01(7,1), Z01(1,1), F01-F04(2,1 each), O01(6,list), O02(4,list), O03(7,list), O04(3,list), O05(3,list), O06(5,list), O07(3,list), O08(3,list), R01(8,list), R02(3,list), R03(5,list), R04(6,list), V01(4,1), V02(3,1), V03(2,0), V04(7,1), V05(6,1), PF01-PF04(2,1 each), PO01(6,list), PO02(4,list), PO03-PO08(equal O03-O08), PR01-PR03(equal R01-R03), PR04(6,list). Cardinality and semantic rules are frozen by the corresponding gate and exact tuple comparison above.
